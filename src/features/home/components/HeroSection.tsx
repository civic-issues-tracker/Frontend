        ...
        <div className='w-full lg:max-w-2xl text-center lg:text-left flex flex-col items-center lg:items-start'>
          ...
          <div className='flex flex-col sm:flex-row justify-center lg:justify-start items-center gap-4 mt-8 w-full sm:w-auto'>
            <Button 
              ...
              className="w-full sm:w-auto px-8 touch-manipulation cursor-pointer"
            >
              {t('hero.buttons.report')}
            </Button>

            <Button 
              variant='secondary' 
              onClick={requestLocation}
              className='flex items-center justify-center gap-2 w-full sm:w-auto px-6 touch-manipulation cursor-pointer'
            >
