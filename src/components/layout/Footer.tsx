      ...
      <div className="relative z-10 w-full bg-white/10 backdrop-blur-3xl py-12 px-8 md:px-20 border-b border-white/40 shadow-inner">
        <div className="max-w-360 mx-auto grid grid-cols-1 md:grid-cols-12 gap-16">
          <div className="md:col-span-5 flex flex-col items-start">
            ...
            <p className="text-primary text-sm leading-relaxed max-w-sm mb-8 font-body">
              {t('footer.about')}
            </p>
            ...
            <div className="space-y-4 border-l-2 border-primary/10 pl-6 py-2">
              <h4 className="text-primary text-[9px] font-black uppercase tracking-[0.4em] mb-4">{t('footer.contact.title')}</h4>
          ...
          <div className="md:col-span-7 grid grid-cols-2 sm:grid-cols-3 gap-10">
            <div>
              <h4 className="text-primary text-[9px] font-black uppercase tracking-[0.4em] mb-8">{t('footer.links.title')}</h4>
            ...
            <div>
              <h4 className="text-primary text-[9px] font-black uppercase tracking-[0.4em] mb-8">{t('footer.categories.title')}</h4>
              <ul className="space-y-4">
            ...
            <div>
              <h4 className="text-primary text-[9px] font-black uppercase tracking-[0.4em] mb-8">{t('footer.language.title')}</h4>
